...
export const ReturnFormModal: React.FC<ReturnFormModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs overflow-y-auto">
      <div className="bg-slate-900 w-full max-w-2xl rounded-2xl shadow-xl border border-slate-700 overflow-hidden my-8">
        
        {/* Header */}
        <div className="bg-slate-900 text-white px-6 py-4 flex items-center justify-between">
          <div>
            <h2 className="text-lg font-bold">Registrar Nova Devolução (Logística Reversa)</h2>
            <p className="text-xs text-slate-500">Preencha os campos obrigatórios para acompanhamento de prazos e alertas de SLA.</p>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          {/* Row 1: Cotação e Código de Rastreio */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-3.5 py-2 text-sm border rounded-lg bg-slate-900 focus:outline-hidden focus:ring-2 focus:ring-blue-500/20 ${
                  errors.cotacao ? 'border-red-500' : 'border-slate-600'
                }`}
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3.5 py-2 text-sm border font-mono rounded-lg bg-slate-900 focus:outline-hidden focus:ring-2 focus:ring-blue-500/20 ${
                  errors.codigoRastreio ? 'border-red-500' : 'border-slate-600'
                }`}
              />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full px-3.5 py-2 text-sm border border-slate-600 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-blue-500/20 bg-slate-900"
              >
                {MOTIVOS_LIST.map(m => (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-[11px] text-slate-500 mt-1">Data base para contagem e gatilhos de SLA.</p>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 text-sm border border-slate-600 rounded-lg bg-slate-900 focus:outline-hidden focus:ring-2 focus:ring-blue-500/20"
              />
            </div>
          </div>
          ...
          <div className="bg-slate-800/60 p-4 rounded-xl border border-slate-700">
            <label className="block text-xs font-semibold text-slate-200 uppercase tracking-wider mb-1 flex items-center gap-1.5">
            ...
            <div className="flex gap-2 mb-2">
              <input
                ...
                className="flex-1 px-3 py-1.5 text-sm border border-slate-600 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-blue-500/20 bg-slate-900"
              />
              <button
                type="button"
          ...
          <div className="grid grid-cols-2 gap-4 border-t border-slate-700 pt-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 text-sm border border-slate-600 rounded-lg bg-slate-900 focus:outline-hidden focus:ring-2 focus:ring-blue-500/20"
              />
              <span className="text-[11px] text-slate-500">Tempo limite para a 1ª ação</span>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 text-sm border border-slate-600 rounded-lg bg-slate-900 focus:outline-hidden focus:ring-2 focus:ring-blue-500/20"
              />
              <span className="text-[11px] text-slate-500">Tempo limite para a conclusão</span>
            </div>
          </div>
